        ...
        <table className="table-auto w-full min-w-[900px] border-2 border-gray-200">
          ...
          <tbody>
            <tr className="border-b-2 border-gray-200">
              ...
              <td className="p-3 text-sm text-gray-900">
                <span className="text-xs inline align-middle text-green-500 bg-green-50 px-2 py-1 rounded-xl">
                  Offer Granted
                </span>
                <div className="inline-block align-middle float-right -mt-2 mr-1">
                  <button
                    className="text-purple-500 border border-purple-500 py-1.5 px-3 rounded-lg text-sm"
                    type="button"
                  >
                    View
                  </button>
